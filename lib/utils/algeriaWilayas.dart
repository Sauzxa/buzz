final List<Map<String, dynamic>> algeriaWilayas = [
  {"id": 1, "name": "Adrar"},
  {"id": 2, "name": "Chlef"},
  {"id": 3, "name": "Laghouat"},
  ...
  {"id": 58, "name": "El Menia"},
  // Added in Nov 2025 to reach 69 wilayas:
  {"id": 59, "name": "Aflou"},
  {"id": 60, "name": "Barika"},
  {"id": 61, "name": "Ksar Chellala"},
  {"id": 62, "name": "Messaad"},
  {"id": 63, "name": "Aïn Oussera"},
  {"id": 64, "name": "Bou Saâda"},
  {"id": 65, "name": "El Abiodh Sidi Cheikh"},
  {"id": 66, "name": "El Kantara"},
  {"id": 67, "name": "Bir El Ater"},
  {"id": 68, "name": "Ksar El Boukhari"},
  {"id": 69, "name": "El Aricha"},
];
